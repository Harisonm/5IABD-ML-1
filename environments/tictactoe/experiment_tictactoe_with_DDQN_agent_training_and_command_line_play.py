from agents import CommandLineAgent, DeepQLearningAgent, DDQNAgent
...
if __name__ == "__main__":
    ...
    agent0 = DeepQLearningAgent(action_space_size=gs.get_action_space_size(), neurons_per_hidden_layer=128,
                                hidden_layers=5)
    agent1 = DDQNAgent(action_space_size=gs.get_action_space_size(), neurons_per_hidden_layer=128,
                                hidden_layers=5)
    agent0.alpha = 0.1
