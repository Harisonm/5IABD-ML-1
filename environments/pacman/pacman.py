...
class PacmanArena(Arena):
    ...
    def __init__(self, width: int, height: int):
        ...
        Gate(self)
        ## Suoni
        self._sounds = [pygame.mixer.Sound('environments/pacman/resources/sound/OpeningSong.wav'),
                        pygame.mixer.Sound('environments/pacman/resources/sound/sound/Dies.wav'),
                        pygame.mixer.Sound('environments/pacman/resources/sound/sound/WakaWaka.wav'),
                        pygame.mixer.Sound('environments/pacman/resources/sound/sound/Siren.wav'),
                        pygame.mixer.Sound('environments/pacman/resources/sound/sound/EatingCherry.wav'),
                        pygame.mixer.Sound('environments/pacman/resources/sound/sound/EatingGhost.wav'),
                        pygame.mixer.Sound('environments/pacman/resources/sound/sound/ExtraLive.wav')]
        self.sound(0).play()
