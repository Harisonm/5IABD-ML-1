...
background = pygame.image.load('environments/pacman/resources/pacman_background.png')
sprites = pygame.image.load('environments/pacman/resources/pacman_sprites.png')
