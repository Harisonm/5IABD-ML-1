...
def build_reinforce_loss(advantages, old_pred):
...
class ReinforcePolicyBrain:
    def __init__(self,
        ...
        loss = build_reinforce_loss(advantages_tensor, old_policy_tensor)
